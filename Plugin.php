...
class AIPen_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function render()
    {
        ...
        echo '    border-radius: 14px 14px 0 0 !important;';
        echo '    writing-mode: horizontal-tb !important;';
        echo '    text-orientation: mixed !important;';
        echo '    padding: 14px 24px !important;';
        echo '    left: 50% !important;';
        echo '    right: auto !important;';
        echo '    transform: translateX(-50%) !important;';
        echo '    font-size: 15px !important;';
        echo '    letter-spacing: 1px !important;';
        ...
        echo '    transform: translateX(-50%) translateY(-2px) !important;';
        echo '  }';
        echo '}';
